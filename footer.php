		...
		<div class="site-info" theme-info="Sakurairo v<?php echo IRO_VERSION; ?>">
			...
			<div class="footer-device function_area">
					...
					<span style="color: #b9b9b9;">
                        ...
                        <?php endif; ?>
                        <br>
						<a href="https://github.com/mirai-mamori/Sakurairo" rel="noopener" target="_blank" id="site-info" >Theme Sakurairo</a><a href="https://docs.fuukei.org/" rel="noopener" target="_blank" id="site-info" > by Fuukei. </a><a>Modified by Shawgg.</a>
					</span>
			</div>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
